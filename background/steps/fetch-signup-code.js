(function attachBackgroundStep4(root, factory) {
  ...
  function createStep4Executor(deps = {}) {
    ...
    async function executeStep4(state) {
      ...
      throwIfStopped();
      if (mail.provider === HOTMAIL_PROVIDER || mail.provider === LUCKMAIL_PROVIDER || mail.provider === CLOUDFLARE_TEMP_EMAIL_PROVIDER || mail.provider === GMAIL_CODE_PROVIDER) {
      ...
      await resolveVerificationStep(4, state, mail, {
        ...
        requestFreshCodeFirst: (mail.provider === HOTMAIL_PROVIDER || mail.provider === GMAIL_CODE_PROVIDER) ? false : true,
